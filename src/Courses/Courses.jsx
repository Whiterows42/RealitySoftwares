          ...
          <div className="row d-flex flex-column align-items-center">
            <div className="col-md-8 col-md-offset-2">
              <div className="d-flex flex-column align-items-center  ">
                ...
                <p className="my-5">
                  Riyality Software Services Sangola: Offline learning provides
                  a focused and distraction-free environment, allowing deep
                  engagement with materials. It fosters independent thinking,
                  encourages critical analysis, and cultivates personal
                  connections through face-to-face interactions, promoting
                  holistic learning experiences. Software training Sangola.
                </p>
              </div>
            </div>
          </div>
